<%-- 
    Document   : account
    Created on : Apr 28, 2014, 8:04:42 AM
    Author     : rmeijer
--%>
...
<head>
    ...
    <title>Titan Bank - Account</title>
</head>
    ...
    <form action="account" method="post">
        ...
        <div class="groupBox">
            ...
            <div class="content_form_2col_r1_300">
                ...
                <div class="content_form_2col_r1_c2">
                    <input type="text" size="30" name="balance" id="balance" required />
	        </div>
            </div>
        </div>
        <!-- Message area -->
            ...
            <div class="content_form_2col_r1_300">
                ...
                <div class="content_form_2col_r1_c2">
                    <div class="submitBox10">
                        ...
                        <!--button onclick="window.back()"/>Back</button-->
