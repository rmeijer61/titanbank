<%-- 
    Document   : transfer2
    Created on : Apr 28, 2014, 4:28:32 PM
    Author     : admin
--%>
    ...
    <div class="transferBoxDetail">
        <div class="content_form_2col_r1">
            ...
            <div class="content_form_2col_r1_c2" >
                <select id="transferFromAccountNum" name="transferFromAccountNum">
...
<div class="transferBox">
    ...
    <div class="transferBoxDetail">
        <div class="content_form_2col_r1">
            ...
            <div class="content_form_2col_r1_c2">
                <select id="transferToAccountNum" name="transferToAccountNum">
                    <option value="">Please select</option>
                    <option value="101">Savings</option>
                    <option value="201">Checking</option>
                </select>    
...
<div class="transferBox">
    ...
    <div class="transferBoxDetail">
        <div>
            <input type="checkbox" name="transferImmediately">Transfer Immediately 
        </div>
        <br />
        <div class="content_form_2col_r1">
            <div class="content_form_2col_r1_c1">		
