 ...
 * @author admin
 */
@WebServlet(name = "TansferServiceServlet", urlPatterns = {"/TansferServiceServlet"})
public class TransferServiceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userLoginStatus.isLoggedIn(userid)) {
            ...
            transactions = transferService.getTransactions(TransferRequest.TransferStatus.PENDING);
            message = "Pending transfers ";
            
            String nextView = "/WEB-INF/jsp/transferactivity.jsp" ;
